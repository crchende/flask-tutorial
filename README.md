...
- fisier python care creaza o aplicatie flask: `hello.py`
        ...
        app = Flask(__name__) # argumentul __name__ este pus la dispozitie de Python si reprezinta chiar numele fisierului, fara extensie
